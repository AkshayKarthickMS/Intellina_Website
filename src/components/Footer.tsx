  ...
  const footerLinks = [
    {
      ...
      links: [
        { name: 'Home', href: '#home' },
        { name: 'About', href: '/about' }, // Updated for routing
    ...
    },
    {
      title: 'Our Team',
      links: [
        { name: 'Developers', href: '#online-games' },
      ],
    },
  ];

  return (
    <footer className="bg-dark-tertiary/50 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="p-2 rounded-full bg-dark-bg text-white hover:text-neon-blue transition-colors duration-300"
              >
          ...
          {footerLinks.map((column, idx) => (
            <div key={idx}>
              <h3 className="text-lg font-future font-semibold mb-4">{column.title}</h3>
